...
@Entity
@Table(name = "TBL_T_PROYEKSI_PENSIUN_BARU")
@NamedStoredProcedureQueries(
        @NamedStoredProcedureQuery(
                name="MutasiPensiun.processCuspProyeksiPensiunBaru",
...
public class ProyeksiPembayaranPensiunBaru extends BaseModel<ProyeksiPembayaranPensiunBaruDto> {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PROYEKSI_PENSIUN_BARU_SEQ")
    @SequenceGenerator(sequenceName = "proyeksiPensiunBaru_seq", allocationSize = 1, name = "PROYEKSI_PENSIUN_BARU_SEQ")
    ...
    @Column(name = "MP_BULANAN_20PERSEN1", length = 22)
    private Long mpBulanan20persen1;

    @Column(name = "MP_BULANAN_20PERSEN2", length = 22)
    private Long mpBulanan20persen2;

    @Column(name = "MP_BULANAN_20PERSEN3", length = 22)
    private Long mpBulanan20persen3;

    @Column(name = "PHDP_BARU2", length = 22)
    private Long phdpBaru2;

    @Column(name = "PHDP_BARU3", length = 22)
    private Long phdpBaru3;

    @Column(name = "MP_BULANAN_10JUTA_BARU1", length = 22)
    private Long mpBulanan10jutaBaru1;

    @Column(name = "MP_BULANAN_10JUTA_BARU2", length = 22)
    private Long mpBulanan10jutaBaru2;

    @Column(name = "MP_BULANAN_10JUTA_BARU3", length = 22)
    ...
    @Override
    public void fromDto(ProyeksiPembayaranPensiunBaruDto dto){
        ...
        this.setMpBulanan20persen1( dto.getMpBulanan20persen1() );
        this.setMpBulanan20persen2( dto.getMpBulanan20persen2() );
        this.setMpBulanan20persen3( dto.getMpBulanan20persen3() );
        this.setPhdpBaru2( dto.getPhdpBaru2() );
        this.setPhdpBaru3( dto.getPhdpBaru3() );
        this.setMpBulanan10jutaBaru1( dto.getMpBulanan10jutaBaru1() );
        this.setMpBulanan10jutaBaru2( dto.getMpBulanan10jutaBaru2() );
        this.setMpBulanan10jutaBaru3( dto.getMpBulanan10jutaBaru3() );
    ...
    @Override
    public ProyeksiPembayaranPensiunBaruDto toDto(){
        ProyeksiPembayaranPensiunBaruDto dto = new ProyeksiPembayaranPensiunBaruDto();
        ...
        dto.setMpBulanan20persen1( this.getMpBulanan20persen1() );
        dto.setMpBulanan20persen2( this.getMpBulanan20persen2() );
        dto.setMpBulanan20persen3( this.getMpBulanan20persen3() );
        dto.setPhdpBaru2( this.getPhdpBaru2() );
        dto.setPhdpBaru3( this.getPhdpBaru3() );
        dto.setMpBulanan10jutaBaru1( this.getMpBulanan10jutaBaru1() );
        dto.setMpBulanan10jutaBaru2( this.getMpBulanan10jutaBaru2() );
        dto.setMpBulanan10jutaBaru3( this.getMpBulanan10jutaBaru3() );
