...
@Entity
@Table(name="VW_MUTASI_JD_MENIKAH_KEMBALI")
@NamedStoredProcedureQueries(
        @NamedStoredProcedureQuery(
                name = "MutasiPensiun.processMutasiPenerimaMPNikah",
                procedureName = "CUSP_MUTASI_PENERIMAMP_NIKAH",
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class, name = "PAR_TGL_NIKAH_PENERIMAMPLAMA"),
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class, name = "PAR_TGL_INFNKH_PENERIMAMPLAMA"),
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = Long.class, name = "PAR_LEBIH_BAYAR_JML_BULAN"),
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = BigDecimal.class, name = "PAR_LEBIH_BAYAR_NOMINAL_13"),
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = Long.class, name = "PAR_LEBIH_BAYAR_JML_BULAN_13"),
...
public class JandaDudaMenikahKembaliViewModel extends BaseModel<JandaDudaMenikahKembaliViewModelDto> {
    ...
    public JandaDudaMenikahKembaliViewModel() {
    }
    ...
    public void fromDto(JandaDudaMenikahKembaliViewModelDto dto){
    ...
    @Override
    public JandaDudaMenikahKembaliViewModelDto toDto() {
        JandaDudaMenikahKembaliViewModelDto dto = new JandaDudaMenikahKembaliViewModelDto();
