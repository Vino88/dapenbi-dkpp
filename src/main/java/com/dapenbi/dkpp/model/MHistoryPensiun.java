...
import com.dapenbi.dkpp.dto.MHistoryPensiunDto;
...
@Entity
@Table(name = "TBL_M_HISTORY_PENSIUN")
public class MHistoryPensiun extends BaseModel<MHistoryPensiunDto> {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "HISTORY_PENSIUN_ID_SEQ")
    @SequenceGenerator(sequenceName = "historyPensiunId_seq", allocationSize = 1, name = "HISTORY_PENSIUN_ID_SEQ")
    @Column(name = "ID_HISTORY_PENSIUN", length = 22)
    private Long id;
    ...
    @Column(name = "NAMA_PREDIKAT", length = 20)
    ...
    private BigDecimal nilaiFpr;
            ...
            @Column(name = "ID_FAKTOR_FS", length = 22)
    ...
    private BigDecimal nilaiFs;
            ...
            @Column(name = "MPS_20PERSEN", length = 22)
    private BigDecimal mps20persen;

            @Column(name = "MPS_10JUTA", length = 22)
    private BigDecimal mps10juta;

            @Column(name = "MPS_100PERSEN", length = 22)
    ...
    private StatusKawin statusKawin;
            ...
            @Column(name = "NAMA_STATUS_KAWIN_PENERIMA_MP", length = 20)
    ...
    private String masaKerjaHentiBulat;
            ...
            @Column(name = "REF_ID_MUTASI", length = 22)
    private Long refIdMutasi;

            @Column(name = "REF_HISTORY_BY_ID_MUTASI", length = 22)
    ...
    private Date tglUsia25tPenerimaMp;
            @Column(name = "MPS_100PERSEN_BULAT", length = 22)
    private BigDecimal mps100persenBulat;

            @Column(name = "FAKTOR_FS", length = 30)
    ...
    @Override
    public void fromDto(MHistoryPensiunDto dto) {
    ...
    @Override
    public MHistoryPensiunDto toDto() {
        MHistoryPensiunDto dto = new MHistoryPensiunDto();
        ...
        dto.setRefHistoryByIdMutasi(this.getRefHistoryByIdMutasi());
