...
@Entity
@Table(name="VW_MUTASI_MP_SEKALIGUS_100")
@NamedStoredProcedureQuery(
        name = "MutasiPensiunView.cuspMutasiMps100",
        procedureName = "CUSP_MUTASI_MPS100",
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class,name = "PAR_TGL_MOHON_MPS100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class,name = "PAR_TGL_BAYAR_MPS100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class,name = "PAR_USIAPNERIMABAYAR_MPS100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class,name = "PAR_USIAPNERIMABAYAR_MPS100BLT"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = Date.class,name = "PAR_TGL_HENTI_BAYAR_MPS100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = BigDecimal.class,name = "PAR_MPS100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = BigDecimal.class,name = "PAR_MPS100_BULAT"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = Long.class,name = "PAR_ID_ALASAN_MPS_100"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class,name = "PAR_NAMA_ALASAN_MPS_100"),
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, type = Long.class,name = "PAR_ID_FAKTOR_FS"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class,name = "PAR_NAMA_FAKTOR_FS"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class,name = "PAR_FAKTOR_FS"),
                @StoredProcedureParameter(mode = ParameterMode.IN, type = BigDecimal.class,name = "PAR_NILAI_FS"),
...
public class MutasiMpSekaligus100View extends BaseModel<MutasiMpSekaligus100ViewDto> {
    ...
    public MutasiMpSekaligus100View() {
    }
    ...
    @Override
    public void fromDto(MutasiMpSekaligus100ViewDto dto) {
    ...
    @Override
    public MutasiMpSekaligus100ViewDto toDto() {
        MutasiMpSekaligus100ViewDto dto = new MutasiMpSekaligus100ViewDto();
