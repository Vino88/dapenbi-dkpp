...
@Entity
@Table(name="VW_MUTASI_OTOMATIS_BULAN_13")
@NamedStoredProcedureQuery(
        name = "MutasiOtomatisBulan13ViewModel.spMutasiOtomatisanak",
        procedureName = "CUSP_MUTASI_OTOM_80PERSEN_UPD",
        parameters = {
                ...
                @StoredProcedureParameter(mode = ParameterMode.IN, type = BigDecimal.class, name = "PAR_MPYD_BARU"),
...
public class MutasiOtomatisBulan13ViewModel extends BaseModel<MutasiOtomatisBulan13ViewDto> {
    ...
    private Date tempatLahirPeserta;
    ...
    public MutasiOtomatisBulan13ViewModel() {
    }
    ...
    public BigDecimal getIdKategoriPenerimaMpBaru() {
        return idKategoriPenerimaMpBaru;
    }
    ...
    public Date getTempatLahirPeserta() {
        return tempatLahirPeserta;
    }

    public void setTempatLahirPeserta(Date tempatLahirPeserta) {
    ...
    public Date getTglUsia25tPenerimaMpBaru() {
        return tglUsia25tPenerimaMpBaru;
    }
    ...
    @Override
    public void fromDto(MutasiOtomatisBulan13ViewDto dto) {
    ...
    @Override
    public MutasiOtomatisBulan13ViewDto toDto() {
        MutasiOtomatisBulan13ViewDto dto = new MutasiOtomatisBulan13ViewDto();
