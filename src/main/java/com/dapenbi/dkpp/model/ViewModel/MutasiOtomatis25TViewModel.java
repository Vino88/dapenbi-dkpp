...
@Entity
@Table(name="VW_MUTASI_OTOMATIS_25T")
@NamedStoredProcedureQueries(
        @NamedStoredProcedureQuery(
                name = "MutasiPensiun.processMutasiOtomatis25T",
                procedureName = "CUSP_MUTASI_OTOM_ANAK25T_UPD",
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, type = String.class, name = "PAR_ID_MUTASI_PENSIUN"),
...
public class MutasiOtomatis25TViewModel extends BaseModel<MutasiOtomatis25TViewModelDto> {
    ...
    public MutasiOtomatis25TViewModel() {
    }
    ...
    public void fromDto(MutasiOtomatis25TViewModelDto dto){
    ...
    @Override
    public MutasiOtomatis25TViewModelDto toDto() {
        MutasiOtomatis25TViewModelDto dto = new MutasiOtomatis25TViewModelDto();
