...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.AKTUARIA_FS)
public class AktuariaFsController {
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(PathPrefix.MASTER_DATA + PathPrefix.FAKTOR_FS, "Aktuaria FS"));
        model.put("breadcrumb", breadcrumb);

        return "masterData/aktuaria-fs";
    }
}
