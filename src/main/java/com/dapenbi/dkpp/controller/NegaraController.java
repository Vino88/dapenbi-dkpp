...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.NEGARA)
public class NegaraController {

    private ServletContext servletContext;

    @Autowired
    public NegaraController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+PathPrefix.MASTER_DATA + PathPrefix.NEGARA, "Master Negara"));
        model.put("breadcrumb", breadcrumb);

        return "masterData/negara";
    }
}
