...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA+PathPrefix.MENU)
public class MenuController {

    private ServletContext servletContext;

    @Autowired
    public MenuController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+"/master-data/menu", "Menu"));

        model.put("breadcrumb", breadcrumb);
        return "masterData/menu";
