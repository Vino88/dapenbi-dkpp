...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.PROVINSI)
public class ProvinsiController {

    private ServletContext servletContext;

    @Autowired
    public ProvinsiController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+"/master-data/provinsi", "Provinsi"));

        model.put("breadcrumb", breadcrumb);
        return "masterData/provinsi";
