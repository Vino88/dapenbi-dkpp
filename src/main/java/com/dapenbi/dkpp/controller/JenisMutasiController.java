...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.JENISMUTASI)
public class JenisMutasiController {

    private ServletContext servletContext;

    @Autowired
    public JenisMutasiController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+"/master-data/jenismutasi", "Jenis Mutasi"));

        model.put("breadcrumb", breadcrumb);
        return "masterData/jenismutasi";
