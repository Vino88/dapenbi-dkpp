...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA+PathPrefix.ROLE)
public class RoleController {

    private ServletContext servletContext;

    @Autowired
    public RoleController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+"/master-data/role", "Role"));

        model.put("breadcrumb", breadcrumb);
        return "masterData/role";
    }
