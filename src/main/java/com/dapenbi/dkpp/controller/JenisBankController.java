...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.JENIS_BANK)
public class JenisBankController {

    private ServletContext servletContext;

    @Autowired
    public JenisBankController(ServletContext servletContext){
    ...
    public String index(Map<String, Object> model) {
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath()+"/master-data/jenis-bank", "Master Jenis Bank"));


        model.put("breadcrumb", breadcrumb);
        return "masterData/jenis-bank";
    }
