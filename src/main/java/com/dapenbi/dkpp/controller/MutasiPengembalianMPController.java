...
@Controller
@RequestMapping(PathPrefix.PEMBAYARAN + PathPrefix.MUTASI_PENGEMBALIAN_MP)
public class MutasiPengembalianMPController {
    ServletContext servletContext;

    @Autowired
    public MutasiPengembalianMPController(ServletContext servletContext){
    ...
    public String index(Map<String,Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(servletContext.getContextPath() + PathPrefix.PEMBAYARAN+PathPrefix.MUTASI_PENGEMBALIAN_MP,"  Mutasi Pengembalian MP"));
        ...
        return "pembayaran/mutasi-pengembalian-mp";
    }
}
