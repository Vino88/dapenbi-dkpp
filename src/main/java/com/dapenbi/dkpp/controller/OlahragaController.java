...
@Controller
@RequestMapping(PathPrefix.MASTER_DATA + PathPrefix.OLAHRAGA)
public class OlahragaController {
    ...
    public String index(Map<String, Object> model){
        ...
        breadcrumb.add(new BreadcrumbHolderComponentDto(PathPrefix.MASTER_DATA + PathPrefix.REKENING_PENERIMA_MP, "Olahraga"));
        model.put("breadcrumb", breadcrumb);

        return "masterData/olahraga";
    }
}
