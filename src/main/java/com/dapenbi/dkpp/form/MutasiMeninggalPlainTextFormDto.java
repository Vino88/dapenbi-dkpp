...
public class MutasiMeninggalPlainTextFormDto {
    ...
    private String parIdNegaraUpdate;
    private String parNamaNegaraUpdate;
    private String parIdPenerimampLama;
    private String parNamaPenerimamplamaUpdate;
    private String parIdKatPenerimampLama;
    private String parTglWftPenerimaMpLama;
    private String parTglInfWftPenerimaMpLama;
    private String parIdPenerimaMpBaru;
    private String parNamaPenerimaMpBaru;
    private String parIdKatPenerimampBaru;
    private String parNamaKatPenerimampBaru;
    private Character parJkPenerimampBaru;
    private String parTglLhrPenerimampBaru;
    private String parIdKawinPenerimampBaru;
    private String parNamaKawinPenerimampBaru;
    private String parIdSuskelBaru;
    private String parNamaSuskelBaru;
    private String parTglBulan13;
    private String parLebihBayarNominal;
    private String parLebihBayarJmlBulan;
    private String parLebihBayarNominal13;
    private String parLebihBayarJmlBulan13;
    private String parNominalTerbayar;
    private String parSaldoAkhirLebihBayar;
    private String parIdStatusBayarUpdate;
    private String parNamaStatusBayarUpdate;
    private String parTglHentiBayarUpdate;
    ...
    public String getParIdMutasi() {
        return parIdMutasi;
    }

    public void setParIdMutasi(String parIdMutasi) {
    ...
    public String getParTglMutasi() {
        return parTglMutasi;
    }

    public void setParTglMutasi(String parTglMutasi) {
    ...
    public String getParIdAgamaUpdate() {
        return parIdAgamaUpdate;
    }

    public void setParIdAgamaUpdate(String parIdAgamaUpdate) {
    ...
    public String getParIdGolonganUpdate() {
        return parIdGolonganUpdate;
    }

    public void setParIdGolonganUpdate(String parIdGolonganUpdate) {
    ...
    public String getParPhdp() {
        return parPhdp;
    }

    public void setParPhdp(String parPhdp) {
    ...
    public String getParTglSpBiUpdate() {
        return parTglSpBiUpdate;
    }

    public void setParTglSpBiUpdate(String parTglSpBiUpdate) {
    ...
    public String getParTglSkBiUpdate() {
        return parTglSkBiUpdate;
    }

    public void setParTglSkBiUpdate(String parTglSkBiUpdate) {
    ...
    public String getParIdProvinsiUpdate() {
        return parIdProvinsiUpdate;
    }

    public void setParIdProvinsiUpdate(String parIdProvinsiUpdate) {
    ...
    public String getParIdKotaKabUpdate() {
        return parIdKotaKabUpdate;
    }

    public void setParIdKotaKabUpdate(String parIdKotaKabUpdate) {
    ...
    public String getParIdKecamatanUpdate() {
        return parIdKecamatanUpdate;
    }

    public void setParIdKecamatanUpdate(String parIdKecamatanUpdate) {
    ...
    public String getParIdKelurahanUpdate() {
        return parIdKelurahanUpdate;
    }

    public void setParIdKelurahanUpdate(String parIdKelurahanUpdate) {
    ...
    public String getParIdNegaraUpdate() {
        return parIdNegaraUpdate;
    }

    public void setParIdNegaraUpdate(String parIdNegaraUpdate) {
    ...
    public String getParIdKatPenerimampLama() {
        return parIdKatPenerimampLama;
    }

    public void setParIdKatPenerimampLama(String parIdKatPenerimampLama) {
        this.parIdKatPenerimampLama = parIdKatPenerimampLama;
    }

    public String getParTglWftPenerimaMpLama() {
        return parTglWftPenerimaMpLama;
    }

    public void setParTglWftPenerimaMpLama(String parTglWftPenerimaMpLama) {
        this.parTglWftPenerimaMpLama = parTglWftPenerimaMpLama;
    }

    public String getParTglInfWftPenerimaMpLama() {
        return parTglInfWftPenerimaMpLama;
    }

    public void setParTglInfWftPenerimaMpLama(String parTglInfWftPenerimaMpLama) {
        this.parTglInfWftPenerimaMpLama = parTglInfWftPenerimaMpLama;
    }
    ...
    public String getParIdKatPenerimampBaru() {
        return parIdKatPenerimampBaru;
    }

    public void setParIdKatPenerimampBaru(String parIdKatPenerimampBaru) {
    ...
    public String getParTglLhrPenerimampBaru() {
        return parTglLhrPenerimampBaru;
    }

    public void setParTglLhrPenerimampBaru(String parTglLhrPenerimampBaru) {
        this.parTglLhrPenerimampBaru = parTglLhrPenerimampBaru;
    }

    public String getParIdKawinPenerimampBaru() {
        return parIdKawinPenerimampBaru;
    }

    public void setParIdKawinPenerimampBaru(String parIdKawinPenerimampBaru) {
    ...
    public String getParIdSuskelBaru() {
        return parIdSuskelBaru;
    }

    public void setParIdSuskelBaru(String parIdSuskelBaru) {
    ...
    public String getParTglBulan13() {
        return parTglBulan13;
    }

    public void setParTglBulan13(String parTglBulan13) {
        this.parTglBulan13 = parTglBulan13;
    }

    public String getParLebihBayarNominal() {
        return parLebihBayarNominal;
    }

    public void setParLebihBayarNominal(String parLebihBayarNominal) {
        this.parLebihBayarNominal = parLebihBayarNominal;
    }

    public String getParLebihBayarJmlBulan() {
        return parLebihBayarJmlBulan;
    }

    public void setParLebihBayarJmlBulan(String parLebihBayarJmlBulan) {
        this.parLebihBayarJmlBulan = parLebihBayarJmlBulan;
    }

    public String getParLebihBayarNominal13() {
        return parLebihBayarNominal13;
    }

    public void setParLebihBayarNominal13(String parLebihBayarNominal13) {
        this.parLebihBayarNominal13 = parLebihBayarNominal13;
    }

    public String getParLebihBayarJmlBulan13() {
        return parLebihBayarJmlBulan13;
    }

    public void setParLebihBayarJmlBulan13(String parLebihBayarJmlBulan13) {
        this.parLebihBayarJmlBulan13 = parLebihBayarJmlBulan13;
    }

    public String getParNominalTerbayar() {
        return parNominalTerbayar;
    }

    public void setParNominalTerbayar(String parNominalTerbayar) {
        this.parNominalTerbayar = parNominalTerbayar;
    }

    public String getParSaldoAkhirLebihBayar() {
        return parSaldoAkhirLebihBayar;
    }

    public void setParSaldoAkhirLebihBayar(String parSaldoAkhirLebihBayar) {
        this.parSaldoAkhirLebihBayar = parSaldoAkhirLebihBayar;
    }

    public String getParIdStatusBayarUpdate() {
        return parIdStatusBayarUpdate;
    }

    public void setParIdStatusBayarUpdate(String parIdStatusBayarUpdate) {
    ...
    public String getParTglHentiBayarUpdate() {
        return parTglHentiBayarUpdate;
    }

    public void setParTglHentiBayarUpdate(String parTglHentiBayarUpdate) {
