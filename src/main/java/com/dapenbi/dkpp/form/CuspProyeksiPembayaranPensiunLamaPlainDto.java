...
public class CuspProyeksiPembayaranPensiunLamaPlainDto {
    private String parCompName;
    private String parUserName;
    private String parTahunProyeksi;
    private String parUntukProyeksi;
    ...
    public void setParUntukProyeksi(String parUntukProyeksi){
        this.parUntukProyeksi = parUntukProyeksi;
    }

    public String getParUntukProyeksi(){
