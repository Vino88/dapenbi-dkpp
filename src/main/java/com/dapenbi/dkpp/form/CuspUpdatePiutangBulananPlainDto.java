...
public class CuspUpdatePiutangBulananPlainDto {
    private String parRoleId;
    private String parCompName;
    private String parUserName;
    private String parIdBayarPiutang;
    ...
    public void setParIdBayarPiutang(String parIdBayarPiutang){
        this.parIdBayarPiutang = parIdBayarPiutang;
    }

    public String getParIdBayarPiutang(){
