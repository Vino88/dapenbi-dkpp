...
public class MutasiMeninggalSPFormDto extends BaseFormDto {
    private Long roleId;
    ...
    private Date parTglWftPenerimaMpLama;
    private Date parTglInfWftPenerimaMpLama;
    ...
    private BigDecimal parLebihBayarJmlBulan;
    private BigDecimal parLebihBayarNominal13;
    private BigDecimal parLebihBayarJmlBulan13;
    ...
    public BigDecimal getParLebihBayarJmlBulan() {
        return parLebihBayarJmlBulan;
    }

    public void setParLebihBayarJmlBulan(BigDecimal parLebihBayarJmlBulan) {
    ...
    public BigDecimal getParLebihBayarJmlBulan13() {
        return parLebihBayarJmlBulan13;
    }

    public void setParLebihBayarJmlBulan13(BigDecimal parLebihBayarJmlBulan13) {
    ...
    public Date getParTglWftPenerimaMpLama() {
        return parTglWftPenerimaMpLama;
    }

    public void setParTglWftPenerimaMpLama(Date parTglWftPenerimaMpLama) {
        this.parTglWftPenerimaMpLama = parTglWftPenerimaMpLama;
    }

    public Date getParTglInfWftPenerimaMpLama() {
        return parTglInfWftPenerimaMpLama;
    }

    public void setParTglInfWftPenerimaMpLama(Date parTglInfWftPenerimaMpLama) {
    ...
    public void fromPlainText(MutasiMeninggalPlainTextFormDto plainDto){
        ...
        this.setParTglWftPenerimaMpLama(stringToDate(plainDto.getParTglWftPenerimaMpLama()) );
        this.setParTglInfWftPenerimaMpLama(stringToDate(plainDto.getParTglInfWftPenerimaMpLama()) );
        ...
        this.setParTglBulan13(plainDto.getParTglBulan13().equals("")? null : stringToDate(plainDto.getParTglBulan13()));
        ...
        this.setParLebihBayarJmlBulan(plainDto.getParLebihBayarJmlBulan().equals("")? null : BigDecimal.valueOf(Long.valueOf(plainDto.getParLebihBayarJmlBulan())));
        ...
        this.setParLebihBayarJmlBulan13(plainDto.getParLebihBayarJmlBulan13().equals("")? null :BigDecimal.valueOf(Long.valueOf(plainDto.getParLebihBayarJmlBulan13())));
        ...
        this.setParTglHentiBayarUpdate(stringToDate(plainDto.getParTglHentiBayarUpdate()) );
