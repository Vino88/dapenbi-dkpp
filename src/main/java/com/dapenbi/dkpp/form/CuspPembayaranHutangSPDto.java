...
public class CuspPembayaranHutangSPDto extends BaseFormDto  {
    ...
    public void fromPlainText(CuspPembayaranHutangPlainDto plainDto){
        this.setParCompName( plainDto.getParCompName());
        this.setParUserName( plainDto.getParUserName());
        this.setParNip( plainDto.getParNip());
        this.setParPeriodeHutang( plainDto.getParPeriodeHutang());
        this.setParType( plainDto.getParType());
    }
